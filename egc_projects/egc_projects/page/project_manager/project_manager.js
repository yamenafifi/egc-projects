frappe.pages["project-manager"].on_page_load = function (wrapper) {
	...
	if (frappe.boot.developer_mode) {
		...
		frappe.hot_update.push(() => load_project_manager(wrapper));
	}
};

frappe.pages["project-manager"].on_page_show = function (wrapper) {
	load_project_manager(wrapper);
};

function load_project_manager(wrapper) {
